...
- Finds FFmpeg from settings, the app-managed install, nearby portable folders, `D:\Tools`, or `PATH`.

## FFmpeg

On Windows, use the Install button to download FFmpeg essentials into the app data folder.
